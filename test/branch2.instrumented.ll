...
entry:
  ...
  call void @__DSE_ICmp__(i32 5, i32 38)
...
land.lhs.true:                                    ; preds = %entry
  ...
  call void @__DSE_ICmp__(i32 8, i32 38)
...
if.then:                                          ; preds = %land.lhs.true2
  call void @__DSE_Branch__(i32 2, i32 10, i32 1)
  %5 = load i32, i32* %x, align 4
  call void @__DSE_Load__(i32 11, i32* %x)
...
if.end:                                           ; preds = %if.then, %land.lhs.true2, %land.lhs.true, %entry
  call void @__DSE_Branch__(i32 2, i32 10, i32 0)
